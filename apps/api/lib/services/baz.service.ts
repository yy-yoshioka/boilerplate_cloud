  ...
  return {
    ...
    async create(data: S.BazCreateInput) {
      ...
      try {
        ...
        logger.error({ model: 'Baz', action: 'create', error: error instanceof Error ? error.message : 'Unknown error' });
        throw createStandardError(ERROR_CODES.INTERNAL_ERROR);
      }
    },
    ...
    async hardDelete(id: string) {
      ...
      try {
        ...
        logger.error({ model: 'Baz', action: 'hardDelete', id, error: error instanceof Error ? error.message : 'Unknown error' });
        throw createStandardError(ERROR_CODES.INTERNAL_ERROR);
      }
    },
  };
